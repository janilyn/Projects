    ...
    # button actions
        ...
        def on_mouse_press(x, y, button, modifiers):
            if button == mouse.LEFT:
                ...
                if x > 315 and x < 410 and y < 205 and y > 155:
                    @window.event
                    def on_draw():
                        obj_start.start_presssprite.draw()

                # when how to play button is pressed
                if x > 435 and x < 530 and y < 205 and y > 155:
                    @window.event
                    def on_draw():
                        obj_start.howtoplay_presssprite.draw()

                # when highscore button is pressed
                if x > 555 and x < 650 and y < 205 and y > 155:
                    @window.event
                    def on_draw():
                        obj_start.highscore_presssprite.draw()
        ...
        def on_mouse_release(x, y, button, modifiers):
            if button == mouse.LEFT:
                ...
                if x > 315 and x < 410 and y < 205 and y > 155:
                    @window.event
                    def on_draw():
                        obj_start.start_hoversprite.draw()
                    username()

                # when how to play button is released
                elif x > 435 and x < 530 and y < 205 and y > 155:
                    @window.event
                    def on_draw():
                        obj_start.howtoplay_hoversprite.draw()
                    howtoplay()
                
                # when highscore button is released
                elif x > 555 and x < 650 and y < 205 and y > 155:
                    @window.event
                    def on_draw():
                        obj_start.highscore_hoversprite.draw()
                    highscore()

                else:
                    @window.event
                    def on_draw():
                        obj_start.start_basesprite.draw()
                        obj_start.howtoplay_basesprite.draw()
                        obj_start.highscore_basesprite.draw()

        @window.event
        def on_mouse_motion(x, y, button, modifiers):
            # when mouse hovers over start button
            if x > 315 and x < 430 and y < 205 and y > 155:
                @window.event
                def on_draw():
                    obj_start.start_hoversprite.draw()

            # when mouse hovers over how to play button
            elif x > 435 and x < 550 and y < 205 and y > 155:
                @window.event
                def on_draw():
                    obj_start.howtoplay_hoversprite.draw()
            
            # when mouse hovers over highscore button
            elif x > 555 and x < 670 and y < 205 and y > 155:
                @window.event
                def on_draw():
                    obj_start.highscore_hoversprite.draw()
    ...
    def __call__(self, *args, **kwargs):
        ...
        with open('user_score.txt', 'r') as f:
            with open('highscore.txt', 'r') as g:
                ...
                if "xxx" in data[1]:
                    ...
                    if float(data[1][-3:-1]) > float(data2[1][-3:-1]):
                        data2[0] = str(data[0])
                        data2[1] = str(data[1])
                    else:
                        None
        ...
        with open('highscore.txt', 'r') as g:
            ...
            if "00:00" in data2[1]:
                ...
                user = data2[0][:-1]
                score = str('Finished within '+ '\n' + str(60 - int(data2[1][-3:-1])) + ' seconds!')
        ...
        #displays highscore
        hs_label = pyglet.text.Label(str(score),
                                    font_name='Arial Rounded MT Bold',
                                    font_size=25,
                                    color=(130,0,0,255),
